...
**글자 수 기준: 각 단계별로 띄어쓰기를 제외한 글자 수가 80~96자가 되도록 작성하세요. (띄어쓰기는 자연스럽게 사용하되, 글자 수를 셀 때만 띄어쓰기를 제외합니다)**

- 1단계 (사건): 각 단계별 띄어쓰기 제외 80~96자. "~했음", "~함", 또는 명사형으로 끝낼 것. ("~사건" 금지)
- 2단계 (현상): 각 단계별 띄어쓰기 제외 80~96자. "~했음", "~함", 또는 명사형으로 끝낼 것. ("~현상" 금지)
- 3단계 (산업/수요 변화): 각 단계별 띄어쓰기 제외 80~96자. 형식 자유.
- 4단계 (기업 이익): 각 단계별 띄어쓰기 제외 80~96자. "~했음", "~함", 또는 명사형으로 끝낼 것. ("~기업 이익" 금지)
